...
namespace CodeEasier.Scene
{
    ...
    */
    ...
    class CETextElement : ICESceneDrawable
    {
        ...
        {
            spriteBatch.DrawString(Font, Text, new Vector2(Rect.X, Rect.Y), Color, MathHelper.ToRadians(Rotation), Vector2.Zero, new Vector2(Rect.Width / Font.MeasureString(Text).X, Rect.Height / Font.MeasureString(Text).Y), SpriteEffects.None, 0);
        }
