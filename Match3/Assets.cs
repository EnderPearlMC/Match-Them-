...
namespace Match3
{
    class Assets
    {
        ...
        public static Texture2D LevelTileOneDot { get; private set; }
        public static Texture2D LevelTileTwoDot { get; private set; }
        public static Texture2D LevelTileFourDot { get; private set; }
        public static Texture2D LevelTileThreeLines { get; private set; }
        public static Texture2D LevelTileTwoLinesH { get; private set; }
        public static Texture2D LevelTileSquare { get; private set; }
        ...
        public static Texture2D FailedText { get; private set; }
        public static Texture2D CompletedText { get; private set; }
        ...
        public static Texture2D SelectLevelBtn { get; private set; }
        public static Texture2D SelectLevelBtnCurrent { get; private set; }
        ...
        public static void Load(ContentManager content, GraphicsDevice graphicsDevice)
        {
            ...
            LevelBackgrounds = new List<Texture2D>()
            {
                ...
                content.Load<Texture2D>("level_bg_3"),
            };
            ...
            LevelTileOneDot = content.Load<Texture2D>("tile_one_dot");
            LevelTileTwoDot = content.Load<Texture2D>("tile_two_dot");
            LevelTileFourDot = content.Load<Texture2D>("tile_four_dot");
            LevelTileThreeLines = content.Load<Texture2D>("tile_three_lines");
            LevelTileTwoLinesH = content.Load<Texture2D>("tile_two_lines_h");
            LevelTileSquare = content.Load<Texture2D>("tile_square");
            ...
            FailedText = content.Load<Texture2D>("failed");
            CompletedText = content.Load<Texture2D>("completed");
            ...
            SelectLevelBtn = content.Load<Texture2D>("select_level_btn");
            SelectLevelBtnCurrent = content.Load<Texture2D>("select_level_btn_current");
