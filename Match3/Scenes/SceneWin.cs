    ...
    class SceneWin : CEScene
    {
        ...
        private void LoadDrawables(Dictionary<string, Object> parameters)
        {
            ...
            if ((bool)parameters["won"])
                ...
                levelCompletedText = new CETextElement(Langs.Texts["level_failed"][BaseGame.game.Lang], Assets.MainFont, new Color(231, 76, 60), new Rectangle(0, 0, 0, 0));
