                        ...
                        if (mouseCol >= 0 && mouseCol < scene.tiles[mouseRow].Count)
                        {
                            if (scene.tiles[mouseRow][mouseCol] != null)
                            {
                                ...
                                if (newMouseState.LeftButton == ButtonState.Pressed && oldMouseState.LeftButton == ButtonState.Released && !scene.tiles[mouseRow][mouseCol].toRemove)
                                {
                                    ...
                                    scene.AddCircleParticle(25, scene.tiles[mouseRow][mouseCol].X + scene.tiles[mouseRow][mouseCol].Width / 2, scene.tiles[mouseRow][mouseCol].Y + scene.tiles[mouseRow][mouseCol].Height / 2, scene.tiles[mouseRow][mouseCol].Width / 2, scene.tiles[mouseRow][mouseCol].Height / 2, 1, scene.tiles[mouseRow][mouseCol].Width / 3, scene.tiles[mouseRow][mouseCol].Width * 3);
                                    scene.AddCircleParticle(30, scene.tiles[mouseRow][mouseCol].X + scene.tiles[mouseRow][mouseCol].Width / 2, scene.tiles[mouseRow][mouseCol].Y + scene.tiles[mouseRow][mouseCol].Height / 2, scene.tiles[mouseRow][mouseCol].Width / 3, scene.tiles[mouseRow][mouseCol].Height / 3, 1.2f, scene.tiles[mouseRow][mouseCol].Width / 3, scene.tiles[mouseRow][mouseCol].Width * 2);
