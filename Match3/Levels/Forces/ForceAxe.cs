        ...
        public override void Update(GameTime gameTime, SceneLevel scene)
        {
            ...
            if (toBreak)
            {
                ...
                if (angle <= -50)
                {
                    ...
                    CEParticle pi = new CEParticle(Assets.FXImpact1, tileToBreak.X, tileToBreak.Y - tileToBreak.Height * 2, tileToBreak.Width, tileToBreak.Height * 2, .3f, 0, 370, 0);

                    scene.emitter1.AddParticle(pi);
